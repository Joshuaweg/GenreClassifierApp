...
@app.route('/plot_nearest_neighbors',methods=['GET'])
def plot_nearest_neighbors():
    ...
    input_features = request.args.get('input_features')
    #need to jsonify the input features
    output = request.args.get('output')
    print("Output: ",output)
    output = int(output)
    print("JSONified input features: ")
    input_features = urllib.parse.unquote(input_features)
...
@app.route('/plot_farthest_neighbors',methods=['GET'])
